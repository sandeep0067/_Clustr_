...
new BigNumber(9, 2)</pre>
    ...
    <pre>new BigNumber({ s: 1, e: 2, c: [ 777, 12300000000000 ], _isBigNumber: true })    
...
BigNumber.isBigNumber(y)             

BN = BigNumber.clone();
z = new BN(x)
z instanceof BigNumber               
BigNumber.isBigNumber(z)             
    <p>
...
BigNumber.maximum(4e9, x, '123456789.9')      

arr = [12, '13', new BigNumber(14)]
BigNumber.max.apply(null, arr)                
    ...
    <p>The return value is always exact and unrounded.</p>
    <pre>x = new BigNumber('3257869345.0378653')
BigNumber.minimum(4e9, x, '123456789.9')      

arr = [2, new BigNumber(-14), '-15.9999', -12]
BigNumber.min.apply(null, arr)                
...
BigNumber.random(20)            
    ...
    <p>The return value is always exact and unrounded.</p>
    <pre>x = new BigNumber('3257869345.0378653')
BigNumber.sum(4e9, x, '123456789.9')      

arr = [2, new BigNumber(14), '15.9999', 12]
BigNumber.sum.apply(null, arr)            
...
x.dp(0, 6)                             
x.decimalPlaces(1, 1)                  
x.dp(1, BigNumber.ROUND_HALF_EVEN)     
x                                      
...
0.1 &gt; (0.3 - 0.2)                             
x = new BigNumber(0.1)
x.isGreaterThan(BigNumber(0.3).minus(0.2))    
BigNumber(0).gt(x)                            
...
0.1 &lt;= (0.3 - 0.2)                                
x = new BigNumber(0.1)
x.isLessThanOrEqualTo(BigNumber(0.3).minus(0.2))  
BigNumber(-1).lte(x)                              
...
x.precision(6)                         
x.sd()                                 
x.precision(6, BigNumber.ROUND_UP)     
x.sd(2)                                
x.precision(2, 1)                      
x                                      
...
x.toFormat(fmt)                           
x.toFormat(2, fmt)                        
x.toFormat(3, BigNumber.ROUND_UP, fmt)    
...
y.valueOf()                     
    ...
    <pre>x = new BigNumber(0.123)              
x.toExponential()                     
x.c                                   
x.e                                   
x.s                                   

y = new Number(-123.4567000e+2)       
y.toExponential()                     
